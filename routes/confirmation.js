...
router.post('/', function(req, res, next) {
	...
	requestApi('https://maps.googleapis.com/maps/api/geocode/json?address=' + req.body.address + '&key=AIzaSyCe5Owcj0cRZ6QeR8XHsJOIdsTvvpTbuyU',
		...
		request.create(riderData, function(err, record) {
			...
			record.sendSmsNotification('Your request for a ride has been confirmed! You will receive another message when a driver confirms your request. Text NEVERMIND to cancel your ride request.'/*, getCallbackUri(req.headers.host, record)*/);
